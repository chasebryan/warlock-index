...
- Added initial strategic assessment products.
- Added the global strategic operating picture and actor-domain assimilation
  matrix.
- Added the U.S. Homeland and Western Hemisphere strategic baseline.
- Added the U.S. Defense Industrial Base strategic baseline.
- Added the Ukraine War external support tracker.
- Added the Taiwan Strait and First Island Chain strategic baseline.
- Added the Global Cyber and Critical Infrastructure strategic baseline.
- Added the Global Space and Counterspace strategic baseline.
- Created actor profile folders for transnational criminal organizations and
  foreign terrorist organizations/nonstate armed networks.
- Added the transnational criminal organizations strategic actor
  classification.
- Added the foreign terrorist organizations and nonstate armed networks
  strategic actor classification.
- Added the Arctic and High North strategic baseline.
- Added the Africa security environment strategic baseline.
- Added the Ukraine War strategic event timeline.
- Added the Taiwan Strait coercion strategic event timeline.
- Added the Red Sea and Houthi maritime disruption strategic event timeline.
...
The repository is in baseline-building mode. Products prioritize:

- Source discipline.
- Strategic clarity.
- Separation of evidence, assumptions, and analytic judgment.
- Dated snapshots that can be revised without erasing prior assessments.

...
| --- | --- | --- | --- | --- |
| ODNI Annual Threat Assessment | Active in repo; used in Russia strategic-weapons packet | Keep annual comparison packet current | High | No classified inference |
...
- CISA or NSA publishes a major joint cyber advisory series affecting tracked
  state actors, ransomware, or critical infrastructure.

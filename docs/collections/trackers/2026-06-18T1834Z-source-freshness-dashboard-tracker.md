...
**Analytic confidence:** High for internal queue structure; moderate for external source completeness.

**Topics:** source freshness; audit; refresh queue; all topics

**Source classes:** Internal tracker; Official; Allied official; Vendor advisory; Research; Media; Geospatial; Maritime
...
**Safety boundary:** Source freshness tracker only. Does not assign collection priorities, operational priorities, or targeting tasks.
...
| NATO / Europe posture | Watch | 2026-06-18T09:45:00Z | 2026-06-25T09:45:00Z | Allied response statements and implementation details. |
| Strategy and warfare research | Reference | 2026-06-18T17:50:00Z | 2026-07-18T17:50:00Z | Academic coverage expansion and doctrine crosswalks. |

## Status Definitions

- `Current`: Source base has been checked recently and is suitable for reuse.
- `Watch`: Topic is changing quickly or depends on recurring official releases.

# LIVE-NEWS Source Audit Tracker

**UNCLASSIFIED//OPEN SOURCE**

**Tracker ID:** WI-TRACKER-LIVE-NEWS-SOURCE-AUDIT-2026-0001

**Prepared UTC:** 2026-06-18T10:15:00Z

**Information cutoff UTC:** 2026-06-18T10:15:00Z

**Source base:** WARLOCK-INDEX LIVE-NEWS page; LIVE-NEWS source-treatment
note; Research and Media Source Register; official live pages and reviewed
candidate routes for public broadcasters, institutional video services,
commercial current-event channels, and public-affairs sources.

**Analytic confidence:** Moderate for source-routing status, inclusion rules,
and current public-card/candidate classification. Low for long-term access,
advertising behavior, region availability, or source usability because live
pages can change without notice.

**Purpose:** Maintain LIVE-NEWS as a curated source system rather than an
arbitrary link list. This tracker records which live sources are public-card
approved, which are reviewed candidates, which need cleaner routes, and what
source-treatment limits apply.

**Boundary:** Source hygiene only. This tracker does not endorse providers,
rate editorial independence, bypass access controls, rebroadcast streams,
embed players, provide legal advice, or convert live observations into
durable corpus claims without follow-on corroboration.

## Bottom Line

LIVE-NEWS should keep a small public card grid and a larger docs-only audit
queue. Public-card sources need an official free route, low-friction access,
and clear source treatment. Candidate sources can be useful for monitoring or
...
| Provider | Official URL | Category | Last checked UTC | Status | Source class | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| NHK World-Japan | `https://www3.nhk.or.jp/nhkworld/en/live/` | Public international broadcaster | 2026-06-18T05:05:04Z | Public-card approved | B/C | Current-event awareness; follow with stable article or official source |
| DW News | `https://www.dw.com/en/live-tv/channel-english` | Public international broadcaster | 2026-06-18T05:05:04Z | Public-card approved | B/C | English live route verified after corrected URL |
| France 24 English | `https://www.france24.com/en/live` | Public international network | 2026-06-18T05:05:04Z | Public-card approved | B/C | Use as current-event reporting source |
| France 24 Francais | `https://www.france24.com/fr/direct` | Public international network | 2026-06-18T05:05:04Z | Public-card approved | B/C | Francophone live route |
| TRT World | `https://www.trtworld.com/live` | Official international broadcaster | 2026-06-18T05:05:04Z | Public-card approved | B/C | Treat as issuer-context media where relevant |
| CNA Live | `https://www.channelnewsasia.com/watch/live` | Official broadcaster | 2026-06-18T05:05:04Z | Public-card approved | B/C | Asia current-event awareness |
| ABC News Australia | `https://www.abc.net.au/news/newschannel` | Public broadcaster | 2026-06-18T05:05:04Z | Public-card approved | B/C | Indo-Pacific public broadcaster |
...
| NASA Live | `https://www.nasa.gov/nasatv/` | U.S. official agency | 2026-06-18T05:05:04Z | Public-card approved | A/B | Official but live observations still need archive or release |
...
| IMF Live | `https://www.imf.org/en/live` | Multilateral institution | 2026-06-18T05:05:04Z | Public-card approved | A/B | Follow with event page, transcript, report, or release |

## Reviewed Candidate Queue

| Candidate | Candidate URL | Reason to keep in queue | Current status | Public-card condition |
| --- | --- | --- | --- | --- |
| Al Jazeera English Live | `https://www.aljazeera.com/video/live` | High-value global/Middle East current-event awareness | Reviewed candidate; prior check found explicit advertisement marker | Add only if a clean official no-paywall, low-ad route is confirmed |
| PBS NewsHour Live | `https://www.pbs.org/newshour/live` | U.S. public-media event and briefing coverage | Reviewed candidate; prior check found support/funder/sponsor surfaces | Add only if low-friction route is confirmed |
...
- Recheck public-card links after major site redesigns, high-traffic crisis
  events, regional-access changes, cookie-wall changes, or video-platform
  changes.
- Keep public-card entries small and source-diverse; do not add every useful
  candidate to the public grid.
- Preserve reviewed candidates in docs so future source work is not lost.
- Move a candidate to public-card approved only after official URL, free
  access, low-friction behavior, and source-treatment label are confirmed.
- Remove or demote public-card sources that become account-required,
  paywall-first, ad-heavy, misleading, or unstable.
- For any live observation, record provider, URL, UTC timestamp, program or
  event title, observed claim, and follow-on corroborating source.

## Cross References

- [LIVE-NEWS Source-Treatment Note](../source-notes/2026-06-18T0352Z-live-news-source-treatment-note.md)

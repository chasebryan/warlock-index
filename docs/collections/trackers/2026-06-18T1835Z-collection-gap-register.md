...
**Topics:** collection gaps; source routing; all topics; audit

**Source classes:** Internal tracker; Official; Allied official; Academic; Commercial data; Vendor advisory
...
**Safety boundary:** Records open-source information gaps only. Does not direct collection, targeting, surveillance, exploitation, or operational activity.

## Gap Register

| Gap | Affected products | Source requirement | Caveat |
| --- | --- | --- | --- |
...
| Academic warfare research expansion | Stratagems source packet and explainer | Additional peer-reviewed sources, doctrine libraries, historical case indexes | archival-reference |

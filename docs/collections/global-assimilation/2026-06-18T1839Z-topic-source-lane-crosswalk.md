...
**Topics:** all topics; source routing; crosswalk; freshness

**Source classes:** Internal matrix; Official; Allied official; Academic; Vendor advisory; Maritime; Geospatial; Media
...
| Topic hub | First source lane | Secondary lane | Standing caveat |
| --- | --- | --- | --- |
| Indo-Pacific | DoD/DIA, allied defense ministries, PRC official issuer language | Think tanks, regional official releases | translation-risk; implementation-gap |
